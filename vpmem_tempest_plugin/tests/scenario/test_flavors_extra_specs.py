...
class FlavorsExtraSpecsTestJSON(base.BaseV2ComputeAdminTest):
    ...
    def test_flavor_set_get_update_show_unset_keys(self):
        ...
        specs = {"hw:numa_nodes": "2", "hw:numa_cpus.0": "0,1", "hw:numa_mem.0": "2048", "hw:numa_cpus.1": "2,3", "hw:numa_mem.1": "2048"}
...
#        RemotePdb('127.0.0.1',4444).set_trace()
        ...
        self.servers_client.delete_server(self.instance['server']['id'])
        waiters.wait_for_server_termination(
                self.servers_client, self.instance['server']['id'], ignore_error=False)

#
#        # UPDATE the value of the extra specs key1
#        update_body = \
#            self.admin_flavors_client.update_flavor_extra_spec(
#                    self.flavor['id'], "hw:numa_nodes", key1="1")
#            self.assertEqual({"hw:numa_nodes": "1"}, update_body)
#
#        # GET extra specs and verify the value of the key2
#        # is the same as before
#        get_body = self.admin_flavors_client.list_flavor_extra_specs(
#            self.flavor['id'])['extra_specs']
#        self.assertEqual(get_body, {"hw:numa_nodes": "1", "hw:numa_cpus.0": "0,1", "hw:numa_mem.0": "2048", "hw:numa_cpus.1": "2,3", "hw:numa_mem.1": "2048"}
#                )
#
